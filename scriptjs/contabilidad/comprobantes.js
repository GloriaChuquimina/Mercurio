...
$(function (){
    ...
    $('#txtCuenta' ).on({
        ...
        //     if (/^\d+(\.\d{0,3})?$/.test(valor) || valor === "") {
        //         // válido, se permite
        //         $(this).data("oldValue", valor);
        //         // $('#txtImporte').val(new Intl.NumberFormat('es-MX').format(data.valoradquisicion));
        //     } else {
...
//     $('#txtImporte').val(new Intl.NumberFormat('es-MX').format(valorImporte));
// }
